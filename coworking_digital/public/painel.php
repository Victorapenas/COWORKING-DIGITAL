<?php
// DEBUG TEMPORÁRIO – depois de tudo funcionando pode remover essas 3 linhas:
...
// trata redirecionamento para a página de configurações
$acao = $_GET['acao'] ?? null;
if ($acao === 'configuracoes') {
    // configuracoes.php está em /public/configuracoes.php
    redirecionar('configuracoes.php');
}

$membrosLideranca           = getMembrosLideranca();
$membrosFuncionariosAgrupados = getMembrosFuncionarios();
